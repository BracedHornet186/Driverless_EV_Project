...
static const _ObjectDetection_type_support_symbol_names_t _ObjectDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_msgs, msg, ObjectDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perception_msgs, msg, ObjectDetection)),
  }
};
...
{
  return &::perception_msgs::msg::rosidl_typesupport_cpp::ObjectDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perception_msgs, msg, ObjectDetection)() {
  return get_message_type_support_handle<perception_msgs::msg::ObjectDetection>();
}
