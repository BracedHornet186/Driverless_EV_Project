...
#include "perception_msgs/msg/detail/object_detection__rosidl_typesupport_fastrtps_c.h"
...
#include "perception_msgs/msg/detail/bounding_box__functions.h"  // bbox

// forward declare type support functions
size_t get_serialized_size_perception_msgs__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_perception_msgs__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_msgs, msg, BoundingBox)();


using _ObjectDetection__ros_msg_type = perception_msgs__msg__ObjectDetection;
  ...
  // Field name: bbox
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, perception_msgs, msg, BoundingBox
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_perception_msgs__msg__BoundingBox(
...
static uint32_t _ObjectDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_msgs__msg__ObjectDetection(
  ...
  size_t current_alignment)
{
  ...
  // member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_perception_msgs__msg__BoundingBox(
  ...
  if (is_plain) {
    ...
    using DataType = perception_msgs__msg__ObjectDetection;
    is_plain =
      (
...
static size_t _ObjectDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_perception_msgs__msg__ObjectDetection(
