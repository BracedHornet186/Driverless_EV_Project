...
#include "perception_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // k1, k2, k3, k4
...
using _BoundingBox__ros_msg_type = perception_msgs__msg__BoundingBox;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->k1), current_alignment);
  // field.name k2

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->k2), current_alignment);
  // field.name k3

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->k3), current_alignment);
  // field.name k4

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->k4), current_alignment);
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_msgs__msg__BoundingBox(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_msgs__msg__BoundingBox;
    is_plain =
      (
      offsetof(DataType, k4) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_perception_msgs__msg__BoundingBox(
