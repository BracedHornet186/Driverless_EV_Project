...
#include "perception_msgs/msg/detail/object_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const perception_msgs::msg::BoundingBox &,
  ...
  size_t current_alignment)
{
  ...
  // Member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
  ...
  if (is_plain) {
    ...
    using DataType = perception_msgs::msg::ObjectDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_msgs::msg::ObjectDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_msgs::msg::ObjectDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const perception_msgs::msg::ObjectDetection *>(
...
static size_t _ObjectDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjectDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectDetection__callbacks = {
  "perception_msgs::msg",
  "ObjectDetection",
...
static rosidl_message_type_support_t _ObjectDetection__handle = {
...
{
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectDetection__handle;
}
