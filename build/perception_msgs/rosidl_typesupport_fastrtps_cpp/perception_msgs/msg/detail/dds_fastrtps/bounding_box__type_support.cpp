...
#include "perception_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const perception_msgs::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_msgs::msg::BoundingBox & ros_message)
{
  // Member: k1
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_msgs::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_msgs, msg, BoundingBox)() {
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
